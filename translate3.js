...
const OPENAI_KEY = 'TA_CLE_OPENAI';
...
async function main() {
  ...
  await workbook.xlsx.readFile('products_fr.xlsx');
  ...
  await workbook.xlsx.writeFile('products_final.xlsx');
  console.log('✅ Terminé ! Fichier: products_final.xlsx');
}
